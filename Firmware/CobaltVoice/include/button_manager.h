...
public:
     ...
     * @param mediaOnly true pour mode media (pas de PRESS_DOWN/LONG_START/LONG_STOP)
     */
    void begin(uint8_t pin, bool activeLow = true, bool mediaOnly = false);
    ...
    /**
     * @brief Lecture directe GPIO (sans debounce) — pour check au boot
     * Ne pas utiliser dans loop(), préférer isPressed()
     */
    bool readRawPressed();
...
extern ButtonManager btnMain;
extern ButtonManager btnVolUp;
extern ButtonManager btnVolDown;
