...
public:
    ...
    /**
     * @brief Met le système en System ON Sleep (WFE)
    ...
    /**
     * @brief Met la flash QSPI en mode deep power-down
     * Consommation ~1µA au lieu de ~15µA en standby
     */
    void flashDeepPowerDown();

    /**
     * @brief Réveille la flash QSPI du deep power-down
     * Délai de réveil ~30µs
     */
    void flashWakeUp();
