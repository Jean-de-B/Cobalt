...
Cobalt est un wearable open-source composé d'un bracelet hardware (nRF52840) et d'une app Android (Flutter). Appuyez sur le bouton, parlez — Cobalt transcrit, comprend et exécute : envoyer un SMS, lancer un timer, contrôler Spotify, ou simplement prendre une note.
...
| IA | Groq (Whisper large-v3 + Llama 3.1 8B), Sherpa-ONNX (offline) |
