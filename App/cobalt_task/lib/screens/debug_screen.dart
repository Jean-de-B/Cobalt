...
/// Ecran debug firmware : affiche les logs BLE en temps réel.
/// Ouvert depuis le menu montre (icône BLE de l'app bar).
          ...
          GestureDetector(
            ...
            child: Padding(
              ...
              child: Icon(
                ...
                size: 18,
                color:
                    _autoScroll ? const Color(0xFF00FF88) : Colors.orange,
              ),
            ),
          ),
          GestureDetector(
            onTap: () {
              final text =
                  _logs.map((e) => '[${e.timeStr}] ${e.message}').join('\n');
            ...
            child: const Padding(
              ...
              child:
                  Icon(Icons.copy, size: 16, color: Color(0xFF666666)),
            ),
          ),
          GestureDetector(
